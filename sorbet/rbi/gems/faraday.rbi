...
class Anonymous_Faraday_Options_523 < Faraday::Options
  def bind; end
  def bind=(_); end
  def boundary; end
  def boundary=(_); end
...
class Faraday::RequestOptions < Anonymous_Faraday_Options_523
  def []=(key, value); end
  def stream_response?; end
end
class Anonymous_Faraday_Options_524 < Faraday::Options
  def ca_file; end
  def ca_file=(_); end
  def ca_path; end
  def ca_path=(_); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_524
  def disable?; end
  def verify?; end
end
class Anonymous_Faraday_Options_525 < Faraday::Options
  def password; end
  def password=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_525
...
class Anonymous_Faraday_Options_526 < Faraday::Options
  def builder; end
  def builder=(_); end
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_526
  def builder_class; end
  def new_builder(block); end
  def request; end
  def ssl; end
end
class Anonymous_Faraday_Options_527 < Faraday::Options
  def method; end
  def method=(_); end
  def parallel_manager; end
  def parallel_manager=(_); end
...
class Faraday::Env < Anonymous_Faraday_Options_527
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
...
class Faraday::Request < Anonymous_Struct_528
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
